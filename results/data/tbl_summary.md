...
| 5 | Smallest rᵢⱼ at s = 1.0, and which pair | `1.3258` — pair (0,1), i.e. classes 0 and 1 |
| 6 | Distance between centres — Dataset I | `3.4056` |
| 7 | Distance between centres — Dataset II | `0.2215` |
| 8 | Explained variance PC1 + PC2 — Dataset I | `66.86%` |
| 9 | Explained variance PC1 + PC2 — Dataset II | `42.27%` |
| 10 | Share of the positive class in `Transported` | `50.36%` (True) vs `49.64%` (False) |
